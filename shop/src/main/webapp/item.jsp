        ...
        <div class="col-md-12 col-xs-12">
            <div class="row" style="margin-bottom: 10px;">
                <div class="col-md-5 col-xs-5">
                    <div>
                        <a href="#"><img class="img-responsive" src="${pageContext.request.contextPath}/upload/${items.getImage()}"/></a>

                    </div>
                </div>
                <div class="col-md-7 col-xs-7 product-info">
                    <div>
                        <h3 class="pord-name">${items.getName()}</h3>
                    </div>
                    <div class="pord-price clearfix">
                        <span class="pord-dispri">￥<strong>${items.getShop_price()}</strong></span>
                        <span class="pord-orpri">￥${items.getMarket_price()}</span>
                    </div>
                        ...
                        <form action="${pageContext.request.contextPath}/cart/add" method="post">
                            ...
                            <div class="mt10 pord-num clearfix">
                                ...
                                <div class="pull-left ml42">
                                    ...
                                    <a href="javascript: if(document.getElementsByClassName('inpt_detail_main_buy_num')[0].value>1){
                                    document.getElementsByClassName('inpt_detail_main_buy_num')[0].value--};void(0)"

                                       class="pull-left num-plus numbtn num-plus btn_detail_main_buy_min"><i
                                            class="ico-detail">-</i></a>
                                    <input type="text" size="2" maxlength="3" stock_num="728" name="buyNum"
                                           limit_num="30"
                                           class="fl nummidbtn num inpt_detail_main_buy_num" value="1">
                                    <a href="javascript:if( document.getElementsByClassName('inpt_detail_main_buy_num')[0].value<${items.getNum()}){
                                    document.getElementsByClassName('inpt_detail_main_buy_num')[0].value++};void(0)"
                                       class="pull-left numbtn num-minus btn_detail_main_buy_plus"><i
                                            class="ico-detail">+</i></a>
                                </div>
                                <span class="pord-stock">（库存：${items.getNum()}）</span>
                            </div>
                        ...
                        <div id="myTabContent" class="tab-content ">
                            <div role="tabpanel" class="tab-pane fade in active" id="home"
                                ...
                                <img class="img-responsive center-block"
                                     src="${pageContext.request.contextPath}/upload/${items.getIdesc()}"/>
                            </div>
